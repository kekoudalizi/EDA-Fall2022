...
Nebraska1 <- filter(NWIS_SiteInof_utm, station_nm == "Missouri River at Nebraska City, NE")

Nebraska2 <- filter(NWIS_SiteInof_utm, station_nm == "North Fork Republican River at Colorado-Nebraska")
...
ggplot() +
  ...
  mapview(Nebraskacountry_sf) +
#  mapview(Lancaster, zcol = "geometry",
  mapview(Lancaster,color='blue') +
